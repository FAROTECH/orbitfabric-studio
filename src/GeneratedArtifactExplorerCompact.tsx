...
function classifyGeneratedArtifacts(
  ...
  return artifacts.map((artifact) => {
    ...
    const isKnown =
      ...
      (relativePath.startsWith("reports/") && relativePath.endsWith("_report.json")) ||
    ...
    return {
      ...
      classification_reason: isKnown
        ? "Known generated artifact matched by documented output path or conservative filename pattern."
